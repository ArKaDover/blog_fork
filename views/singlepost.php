...
<div class="container d-flex flex-column my-4">
    <?php if (!empty($_SESSION)) : ?>
        <div class="col-md-8 mx-auto ">
            <h1><?= $result['title'] ?><a href="index.php?target=post&action=update&id=<?= $_GET['id']; ?>" class="ms-4"><i class="fas fa-pencil-alt"></i></a> </h1>
    ...
    <?php else : ?>
        ...
        <div class="col-md-8 mx-auto ">
            ...
            <p class="float-end text-primary "><a href="index.php?target=likes&action=create&t=1&id=<?= $result['id'] ?>" class="text-decoration-none"><i class="fas fa-thumbs-up fa-lg"></i> J'aime </a>(<?= count(getLikes($result['id'])) ?>)</p>
        </div>
    <?php endif; ?>
    ...
    <div class="col-7 mx-auto">
        <form action="index.php?target=commentaries&action=create&id=<?= $result['id'] ?>" method="POST">
