    ...
    <?php foreach (getAllComments(0) as $comm) : ?>
        <div class="card col-5 m-3 p-0">
            ...
            <div class="card-body">
                ...
                <a href="index.php?target=commentaries&action=update&id=<?= $comm['id']; ?>" class="text-success"><i class="fas fa-check fa-2x"></i></i></a>
                <a href="index.php?target=commentaries&action=delete&id=<?= $comm['id']; ?>" class="text-danger float-end"><i class="fas fa-times fa-2x"></i></a><br>
            </div>
        </div>
    <?php endforeach; ?>
</div>
